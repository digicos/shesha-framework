...
export type metadataGetProps = Omit<RestfulShesha.GetProps<MetadataDtoAjaxResponse, IAjaxResponseBase, MetadataGetQueryParams, void>, 'queryParams'>;
export declare const metadataGet: (queryParams: MetadataGetQueryParams, props: metadataGetProps) => Promise<MetadataDtoAjaxResponse>;
export type UseMetadataGetProps = Omit<UseGetProps<MetadataDtoAjaxResponse, MetadataGetQueryParams, void>, 'path'>;
export declare const useMetadataGet: (props: UseMetadataGetProps) => import("../hooks/useGet").UseGetReturn<MetadataDtoAjaxResponse, IAjaxResponseBase, MetadataGetQueryParams, void>;
