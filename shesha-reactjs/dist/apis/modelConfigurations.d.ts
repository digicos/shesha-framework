...
export type modelConfigurationsGetByIdProps = Omit<RestfulShesha.GetProps<ModelConfigurationDtoAjaxResponse, IAjaxResponseBase, EmptyQueryParams, ModelConfigurationsGetByIdPathParams> & {
    id: string;
}, 'queryParams'>;
export declare const modelConfigurationsGetById: (queryParams: EmptyQueryParams, { id, ...props }: modelConfigurationsGetByIdProps) => Promise<ModelConfigurationDtoAjaxResponse>;
export type modelConfigurationsUpdateProps = Omit<RestfulShesha.MutateProps<ModelConfigurationDtoAjaxResponse, IAjaxResponseBase, EmptyQueryParams, ModelConfigurationDto, void>, 'data'>;
export declare const modelConfigurationsUpdate: (data: ModelConfigurationDto, props: modelConfigurationsUpdateProps) => Promise<ModelConfigurationDtoAjaxResponse>;
export type modelConfigurationsCreateProps = Omit<RestfulShesha.MutateProps<ModelConfigurationDtoAjaxResponse, IAjaxResponseBase, EmptyQueryParams, ModelConfigurationDto, void>, 'data'>;
export declare const modelConfigurationsCreate: (data: ModelConfigurationDto, props: modelConfigurationsCreateProps) => Promise<ModelConfigurationDtoAjaxResponse>;
...
export type entityConfigDeleteProps = Omit<RestfulShesha.MutateProps<void, unknown, EntityConfigDeleteQueryParams, void, void>, 'data'>;
export declare const entityConfigDelete: (props: entityConfigDeleteProps) => Promise<void>;
...
export type modelConfigurationsMergeProps = Omit<RestfulShesha.MutateProps<ModelConfigurationDtoAjaxResponse, IAjaxResponseBase, ModelConfigurationsMergeQueryParams, MergeConfigurationDto, void>, 'data'>;
export declare const modelConfigurationsMerge: (data: MergeConfigurationDto, props: modelConfigurationsMergeProps) => Promise<ModelConfigurationDtoAjaxResponse>;
export {};
