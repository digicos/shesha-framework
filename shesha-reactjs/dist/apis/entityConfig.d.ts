...
export type entityConfigGetEntityConfigFormProps = Omit<RestfulShesha.GetProps<FormIdFullNameDtoAjaxResponse, IAjaxResponseBase, EntityConfigGetEntityConfigFormQueryParams, void>, 'queryParams'>;
export declare const entityConfigGetEntityConfigForm: (queryParams: EntityConfigGetEntityConfigFormQueryParams, props: entityConfigGetEntityConfigFormProps) => Promise<FormIdFullNameDtoAjaxResponse>;
...
export type UseEntityConfigGetMainDataListProps = Omit<UseGetProps<EntityConfigDtoPagedResultDtoAjaxResponse, EntityConfigGetMainDataListQueryParams, void>, 'path'>;
export declare const useEntityConfigGetMainDataList: (props: UseEntityConfigGetMainDataListProps) => import("../hooks/useGet").UseGetReturn<EntityConfigDtoPagedResultDtoAjaxResponse, IAjaxResponseBase, EntityConfigGetMainDataListQueryParams, void>;
