...
export type referenceListGetByNameProps = Omit<RestfulShesha.GetProps<ReferenceListWithItemsDtoAjaxResponse, IAjaxResponseBase, ReferenceListGetByNameQueryParams, void>, 'queryParams'>;
/**
 * Get current form configuration by name
 */
export declare const referenceListGetByName: (queryParams: ReferenceListGetByNameQueryParams, props: referenceListGetByNameProps) => Promise<ReferenceListWithItemsDtoAjaxResponse>;
