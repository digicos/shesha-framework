...
export type configurableComponentGetByNameProps = Omit<RestfulShesha.GetProps<ConfigurableComponentDtoAjaxResponse, IAjaxResponseBase, ConfigurableComponentGetByNameQueryParams, void>, 'queryParams'>;
/**
 * Get current component configuration by name
 */
export declare const configurableComponentGetByName: (queryParams: ConfigurableComponentGetByNameQueryParams, props: configurableComponentGetByNameProps) => Promise<ConfigurableComponentDtoAjaxResponse>;
...
export type configurableComponentUpdateSettingsProps = Omit<RestfulShesha.MutateProps<void, unknown, ConfigurableComponentUpdateSettingsQueryParams, ConfigurableComponentUpdateSettingsInput, void>, 'data'>;
export declare const configurableComponentUpdateSettings: (data: ConfigurableComponentUpdateSettingsInput, props: configurableComponentUpdateSettingsProps) => Promise<void>;
