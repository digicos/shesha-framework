...
export type UsePermissionedObjectGetAllTreeProps = Omit<UseGetProps<PermissionedObjectDtoListAjaxResponse, PermissionedObjectGetAllTreeQueryParams, void>, 'path'>;
/**
 * Get hierarchical list of protected objects
 */
export declare const usePermissionedObjectGetAllTree: (props: UsePermissionedObjectGetAllTreeProps) => import("../hooks/useGet").UseGetReturn<PermissionedObjectDtoListAjaxResponse, IAjaxResponseBase, PermissionedObjectGetAllTreeQueryParams, void>;
