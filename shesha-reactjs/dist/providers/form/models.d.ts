...
export declare const ROOT_COMPONENT_KEY: string;
export declare const TOOLBOX_COMPONENT_DROPPABLE_KEY: string;
export declare const TOOLBOX_DATA_ITEM_DROPPABLE_KEY: string;
export declare const SILENT_KEY: string;
export interface ISubmitActionArguments {
    validateFields?: boolean;
}
export declare const SubmitActionArgumentsMarkup: IConfigurableFormComponent[];
...
export type ConfigurableFormComponentTypes = 'alert' | 'address' | 'toolbar' | 'dropdown' | 'textField' | 'textField' | 'textArea' | 'iconPicker' | 'container' | 'collapsiblePanel' | 'autocomplete' | 'checkbox' | 'numberField' | 'sectionSeparator' | 'queryBuilder' | 'labelValueEditor';
 ...
 */
export interface IConfigurableFormComponent extends IFormComponentContainer, IHasVersion, IComponentBindingProps, IComponentLabelProps, IComponentVisibilityProps, IComponentRuntimeProps, IComponentMetadata {
...
export type FormMarkup = FormRawMarkup | FormMarkupWithSettings | ((data: any) => FormRawMarkup | FormMarkupWithSettings);
...
export declare const DEFAULT_FORM_SETTINGS: IFormSettings;
export type ActionParametersJs = string;
export type ActionParametersDictionary = [{
    key: string;
    value: string;
}];
