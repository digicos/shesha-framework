...
/** initial state */
export declare const CONFIGURABLE_ACTION_DISPATCHER_CONTEXT_INITIAL_STATE: IConfigurableActionDispatcherStateContext;
export declare const ConfigurableActionDispatcherStateContext: import("react").Context<IConfigurableActionDispatcherStateContext>;
export declare const ConfigurableActionDispatcherActionsContext: import("react").Context<IConfigurableActionDispatcherActionsContext>;
