...
/** initial state */
export declare const CONFIGURATION_ITEMS_LOADER_CONTEXT_INITIAL_STATE: IConfigurationItemsLoaderStateContext;
export declare const ConfigurationItemsLoaderStateContext: import("react").Context<IConfigurationItemsLoaderStateContext>;
export declare const ConfigurationItemsLoaderActionsContext: import("react").Context<IConfigurationItemsLoaderActionsContext>;
