...
export interface IPersistedFormPayload extends Pick<IPersistedFormProps, 'id' | 'versionNo' | 'versionStatus' | 'description' | 'module' | 'name'> {
}
...
export declare const SUB_FORM_CONTEXT_INITIAL_STATE: ISubFormStateContext;
export declare const SubFormContext: import("react").Context<ISubFormStateContext>;
export declare const SubFormActionsContext: import("react").Context<ISubFormActionsContext>;
