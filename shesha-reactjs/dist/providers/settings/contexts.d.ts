...
/** initial state */
export declare const SETTINGS_CONTEXT_INITIAL_STATE: ISettingsStateContext;
export declare const SettingsContext: import("react").Context<ISettingsActionsContext>;
