...
export type IndexColumnFilterOption = 'contains' | 'startsWith' | 'endsWith' | 'equals' | 'lessThan' | 'greaterThan' | 'between' | 'before' | 'after';
...
export declare const isDataColumn: (column: ITableColumn) => column is ITableDataColumn;
export declare const isFormColumn: (column: ITableColumn) => column is ITableFormColumn;
