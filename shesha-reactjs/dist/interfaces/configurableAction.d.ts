...
export declare const hasPreviousActionError: (value: HasPreviousActionResult) => value is IHasPreviousActionError;
export declare const HasPreviousActionResponse: (value: HasPreviousActionResult) => value is IHasPreviousActionResponse;
/**
 * Configuration action executer
 */
export type IConfigurableActionExecuter<TArguments, TReponse> = (actionArguments: TArguments, context: IActionExecutionContext) => Promise<TReponse>;
...
export type IConfigurableActionArgumentsFormFactory<TModel = IConfigurableActionArguments> = (props: ISettingsFormFactoryArgs<TModel>) => ReactNode;
...
export declare const EMPTY_DYNAMIC_CONTEXT_HOOK: DynamicContextHook;
export interface ConfigurableActionArgumentsMigrationContext {
}
/**
 * Arguments migrator
 */
export type ConfigurableActionArgumentsMigrator<TArguments> = (migrator: Migrator<any, TArguments, ConfigurableActionArgumentsMigrationContext>) => MigratorFluent<TArguments, TArguments, ConfigurableActionArgumentsMigrationContext>;
/**
 ...
 */
export declare const makeDefaultActionConfiguration: (props: Pick<IConfigurableActionConfiguration, "actionName" | "actionOwner">) => IConfigurableActionConfiguration;
