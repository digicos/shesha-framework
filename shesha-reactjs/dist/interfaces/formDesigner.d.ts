...
import { FormMarkup, IConfigurableFormComponent, IFlatComponentsStructure, IFormComponentContainer, IFormSettings } from '../providers/form/models';
...
export declare const DEFAULT_FORM_LAYOUT_SETTINGS: IFormLayoutSettings;
...
export interface IToolboxComponent<TModel extends IConfigurableFormComponent = IConfigurableFormComponent> {
    /**
