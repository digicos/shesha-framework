...
export type { IApiEndpoint, IObjectMetadata, IModelMetadata, IEntityMetadata, IPropertyMetadata, IHasEntityType, TypeDefinition, SourceFile, ITypeDefinitionLoadingContext, } from './metadata';
