...
export declare const isStyledColumn: <D extends object = {}>(column: DataTableColumn<D>) => column is IStyledColumn<D>;
...
export type OnSaveSuccessHandler = (data: object, formApi: FormApi, globalState: object, setGlobalState: Function) => void;
