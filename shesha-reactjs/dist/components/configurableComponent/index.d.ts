 ...
 * Settings migrator
 */
export type ComponentSettingsMigrator<TSettings> = (migrator: Migrator<any, TSettings, ComponentSettingsMigrationContext>) => MigratorFluent<TSettings, TSettings, ComponentSettingsMigrationContext>;
...
export declare const ConfigurableApplicationComponent: <TSettings extends unknown>({ children, canConfigure, defaultSettings, settingsEditor, name, isApplicationSpecific, migrator, }: IConfigurableApplicationComponentProps<TSettings>) => React.JSX.Element;
